...
class Produtos:
    ...
    def createTable(self): 
        try:        
            create_table_query = '''CREATE TABLE gestao.produtos 
    ...
    def addNovoProduto(self, id_fornecedor, id_categoria, nomeProduto, descricaoProduto, valorUnitario, quantidade, quantidadeMinima):
        try:
            insert_table_query = '''INSERT INTO gestao.produtos (id_fornecedor, id_categoria, 
            nomeProduto, descricaoProduto, valorUnitario, quantidade, quantidadeMinima) VALUES (%s, %s, %s, %s, %s, %s, %s)'''
            values = (id_fornecedor, id_categoria, nomeProduto, descricaoProduto, valorUnitario, quantidade, quantidadeMinima)
